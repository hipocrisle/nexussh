...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            localfs::fs_local_drives,
            localfs::fs_local_mkdir,
            localfs::fs_local_rename,
            localfs::fs_local_delete,
            ...
            account::account_record_snippet_tombstones,
            account::account_repull_snippets,
            account::ai_status,
            account::ai_request,
            account::ai_suggest,
