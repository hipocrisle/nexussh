...
const ru = {
  ...
  settings: {
    ...
    behavior: {
      ...
      ssh_config_import: "Импорт из ~/.ssh/config",
      ssh_config_import_hint: "Прочитать локальный SSH config и добавить все Host-блоки сразу. Уже добавленные пропускаются.",
      ssh_config_import_btn: "Импортировать...",
...
const en = {
  ...
  settings: {
    ...
    behavior: {
      ...
      ssh_config_import: "Import from ~/.ssh/config",
      ssh_config_import_hint: "Read your local SSH config and add every Host block in one go. Already-imported entries are skipped.",
      ssh_config_import_btn: "Import...",
